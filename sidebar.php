<aside class="sidebar">
	...
	if ( is_active_sidebar( 'sidebar' ) ) {
		...
		the_widget( 'GinkGos_Recent_Posts',
			array(
				'number_of_posts' 	=> '5',
				'widget_title'		=> __( 'Recent Posts', 'ginkgos' ),
			),
			array(
				'before_title' 	=> '<h3 class="widget-title">',
				'after_title'	=> '</h3>',
				'before_widget' => '<div class="widget widget_ginkgos_recent_posts"><div class="widget-content">',
				'after_widget' 	=> '</div></div>',
			)
		);
